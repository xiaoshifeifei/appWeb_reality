      ...
      >
        ...
        >
          <template #default="scope">
            <div>{{ dataGet(scope.row.day) }}</div>
          </template>
        </el-table-column>

        <el-table-column
          align="center"
          :label="t('tableColumn.accountOnlineNum')"
          prop="accountOnlineNum"
        />
        <el-table-column
          align="center"
          :label="t('tableColumn.accountNewAddNum')"
          prop="accountNewAddNum"
        >
        </el-table-column>

        <el-table-column
          align="center"
          :label="t('tableColumn.oneDayRetainedNum')"
          prop="oneDayRetainedNum"
        />
        <el-table-column
          align="center"
          :label="t('tableColumn.threeDayRetainedNum')"
          prop="threeDayRetainedNum"
        />
        <el-table-column
          align="center"
          :label="t('tableColumn.sevenDayRetainedNum')"
          prop="sevenDayRetainedNum"
        />

        <el-table-column
          align="center"
          :label="t('tableColumn.thirtyDayRetainedNum')"
          prop="thirtyDayRetainedNum"
        />
...
const getTableData = async () => {
  ...
  const table = await getSiteDayRetained({
    page: page.value,
